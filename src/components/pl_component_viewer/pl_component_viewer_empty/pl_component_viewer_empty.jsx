...
export class PlComponentViewerEmpty extends Component {
    ...
    render() {
        ...
        var text_measurements;
        var text_center_line;
        var text_mesh;

        if(measurements === false){
            text_measurements = <p>1) Drag measurements (.xlsx)</p>;
        }else{
            text_measurements = <p>1) Measurements imported <svg className="icon" width='12' height='9' viewBox='0 0 12 9' fillRule='evenodd'><path d='M4.1 6.1L1.4 3.4 0 4.9 4.1 9l7.6-7.6L10.3 0z'></path></svg></p>
        }

        if(center_line === false){
            text_center_line = <p>3) Drag center_line (.vtk)</p>;
        }else{
            text_center_line = <p>3) Center line imported <svg className="icon" width='12' height='9' viewBox='0 0 12 9' fill-rule='evenodd'><path d='M4.1 6.1L1.4 3.4 0 4.9 4.1 9l7.6-7.6L10.3 0z'></path></svg></p>;
        }

        if(mesh === false){
            text_mesh=<p>2) Drag Mesh (.stl)</p>;
        }else{
            text_mesh=<p>2) Mesh imported <svg className="icon" width='12' height='9' viewBox='0 0 12 9' fill-rule='evenodd'><path d='M4.1 6.1L1.4 3.4 0 4.9 4.1 9l7.6-7.6L10.3 0z'></path></svg></p>;
        }
        ...
        return (
            <div className="grid-block vertical" style={{overflow:"hidden"}}>
                ...
                <div className="grid-block vertical  shrink pl-component-viewer-empty-message">
                    <div className="grid-block align-center text-center"><h4>Drag and drop files</h4></div>
